...
assert_contains "GNSS_PUBLISH_RATE_HZ=5.0 (default)" "GNSS_PUBLISH_RATE_HZ=5.0" "$ENV_CONTENT"
assert_contains "GNSS_PUBLIC_RTCM_ENABLED=true (default)" "GNSS_PUBLIC_RTCM_ENABLED=true" "$ENV_CONTENT"
assert_contains "GNSS_DIAGNOSTIC_PROJECTION_ENABLED=true (default)" "GNSS_DIAGNOSTIC_PROJECTION_ENABLED=true" "$ENV_CONTENT"
