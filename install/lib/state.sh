...
is_allowed_installer_key() {
  ...
  case "$key" in
    ROS_DOMAIN_ID|ROS_AUTOMATIC_DISCOVERY_RANGE|MOWGLI_SYSTEM_ROLE|MOWER_IP|DISABLE_BLUETOOTH|ENABLE_FOXGLOVE|\
    ...
    GNSS_NTRIP_ENABLED|GNSS_NTRIP_HOST|GNSS_NTRIP_PORT|GNSS_NTRIP_MOUNTPOINT|GNSS_NTRIP_USERNAME|GNSS_NTRIP_PASSWORD|GNSS_RTCM_FORWARDING|\
    GNSS_NTRIP_GGA_ENABLED|GNSS_NTRIP_GGA_INTERVAL_S|GNSS_PUBLISH_RATE_HZ|GNSS_PUBLIC_RTCM_ENABLED|GNSS_DIAGNOSTIC_PROJECTION_ENABLED|\
    ...
    IMAGE_TAG|\
    MOWGLI_ROS2_IMAGE|GPS_IMAGE|LIDAR_IMAGE|MAVROS_IMAGE|GUI_IMAGE|\
    ...
    ENABLE_VESC|VESC_IMAGE|VESC_CAN_INTERFACE|RANGE_IMAGE)
      return 0
      ;;
    *)
      return 1
